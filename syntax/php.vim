...
" Control Structures
syn keyword phpKeyword continue case default break return goto as endif endwhile endfor endforeach endswitch declare endeclare print new clone yield contained
...
if php_folding != 1
  ...
  syn keyword phpKeywordSpecial echo function contained
...
" Function name
syn keyword phpKeywordSpecial function contained
...
" Clusters
syn cluster phpClConst contains=phpFunctions,phpClasses,phpStaticClasses,phpIdentifier,phpStatement,phpKeyword,phpKeywordSpecial,phpOperator,phpSplatOperator,phpStringSingle,phpStringDouble,phpBacktick,phpNumber,phpType,phpNullValue,phpBoolean,phpStructure,phpMethodsVar,phpConstants,phpException,phpSuperglobals,phpMagicConstants,phpServerVars
